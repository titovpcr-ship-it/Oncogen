...
# Буквы с диакритикой приводятся к латинским, а НЕ выбрасываются.
# Прогон 13.09.2026 выдал «Blue Öyster Cult» как опечатку в «blue oyster
# cult»: умляут не попадал в [a-z], и от имени оставалось «Blue yster
# Cult». Продавец написал верно, ошибку сделал разбор.
_DIA = str.maketrans({
...
def fold(s):
    """Нижний регистр с латинизацией диакритики."""
    return s.lower().translate(_DIA)
